...
export default function SEOContent({ currentView, onNavigate, onApplyPreset }: SEOContentProps) {
  ...
  const ALL_SEO_PAGES = [
    ...
    },
    {
      ...
      description: 'Create polished LinkedIn portraits and corporate headshots using clean background removal techniques.',
      category: 'Article',
      iconName: 'eye'
    },
    {
      ...
      description: 'Use free background removal tools to make marketing images, product shots, and social posts stand out.',
      category: 'Article',
      iconName: 'coins'
    }
  ];
  ...
  if (currentView === 'passport-photo') {
    return (
      <div className="mx-auto max-w-4xl px-6 sm:px-10 py-10 animate-fadeIn bg-white text-neutral-900 border border-neutral-150 rounded-3xl mt-8 mb-16 shadow-lg leading-relaxed">
        ...
        <div className="prose prose-neutral max-w-none">
          ...
          <ol className="text-xs sm:text-sm text-neutral-600 space-y-3 pl-5 mb-8">
            ...
            <li>
              <strong>Upload Image:</strong> Select or drag your image into <em>BGIRemove</em>.
            </li>
            <li>
  ...
  if (currentView === 'blog') {
    return (
      <div className="mx-auto max-w-6xl px-6 sm:px-10 py-12 animate-fadeIn bg-white text-neutral-900 border border-neutral-150 rounded-3xl mt-8 mb-16 shadow-lg leading-relaxed">
        <div className="text-center mb-12">
          <span className="inline-flex items-center space-x-1.5 rounded-full bg-orange-50 px-3 py-1 text-xs font-bold text-orange-600 uppercase tracking-widest mb-3">
            ...
            <span>Official BGIRemove Blog</span>
          </span>
  ...
  if (currentView === 'article-remove-bg') {
    return (
      <div className="mx-auto max-w-3xl px-6 sm:px-10 py-12 animate-fadeIn bg-white text-neutral-900 border border-neutral-150 rounded-3xl mt-8 mb-16 shadow-lg leading-relaxed">
    ...
    return (
      <div className="mx-auto max-w-3xl px-6 sm:px-10 py-12 animate-fadeIn bg-white text-neutral-900 border border-neutral-150 rounded-3xl mt-8 mb-16 shadow-lg leading-relaxed">
        ...
        <div className="prose prose-neutral max-w-none text-xs sm:text-sm text-neutral-600 space-y-5 leading-relaxed">
          ...
          <p>
            To resolve this in <strong>BGIRemove</strong>, we developed a specialized <strong>Context/Rescale Mode</strong>! 
          ...
          <ol className="list-decimal pl-5 space-y-2">
            ...
            <li>
              <strong>Import into BGIRemove:</strong> Drop the original camera raw files into the workspace.
            </li>
            <li>
  ...
  // -------------------------------------------------------------
  // VIEW: ARTICLE 4 - Professional Headshots
  // -------------------------------------------------------------
  if (currentView === 'article-professional-headshots') {
    return (
      <div className="mx-auto max-w-3xl px-6 sm:px-10 py-12 animate-fadeIn bg-white text-neutral-900 border border-neutral-150 rounded-3xl mt-8 mb-16 shadow-lg leading-relaxed">
        ...
        <header className="mb-8">
          <div className="flex justify-center mb-4">
            <span className="rounded-full bg-cyan-50 px-3 py-1 font-mono text-xs font-extrabold text-cyan-600 uppercase tracking-widest">Portrait Guide</span>
          </div>
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight text-neutral-900 text-center leading-tight mb-4">
            Professional Headshots: Remove Backgrounds Like a Pro
          </h1>
          <p className="text-sm font-medium text-neutral-500 text-center max-w-xl mx-auto">
            Create polished LinkedIn portrait assets and corporate headshots using clean background removal techniques.
          </p>
        </header>

        <div className="prose prose-neutral max-w-none text-xs sm:text-sm text-neutral-600 space-y-5 leading-relaxed">
          <p>
            A strong professional headshot helps you stand out in job applications, networking platforms, and portfolio pages. The right background can transform a normal portrait into a premium business image.
          </p>
          
          <h3 className="text-base font-black text-neutral-900 mt-6 tracking-tight">Why Backgrounds Matter for Headshots</h3>
          <p>
            Clean backgrounds remove distractions and put the focus squarely on your face. For corporate branding, this means a sharper, more confident presentation that aligns with modern professional profiles.
          </p>
          
          <h3 className="text-base font-black text-neutral-900 mt-6 tracking-tight">Ideal Headshot Composition</h3>
          <ul className="list-disc pl-5 space-y-2">
            <li><strong>Focus on the face:</strong> Keep the head and shoulders centered and fill 60-70% of the frame.</li>
            <li><strong>Professional expression:</strong> Use a natural, approachable smile with direct eye contact.</li>
            <li><strong>Simple clothing:</strong> Wear neutral, solid colors for a clean look.</li>
            <li><strong>Soft light:</strong> Avoid harsh shadows on the face and background.</li>
          </ul>

          <h3 className="text-base font-black text-neutral-900 mt-6 tracking-tight">Step-by-Step Headshot Workflow</h3>
          <ol className="list-decimal pl-5 space-y-2">
            <li>
              <strong>Capture a sharp source photo:</strong> Use good lighting, minimal background clutter, and a medium distance.
            </li>
            <li>
              <strong>Upload to BGI Remove:</strong> Drop the image into the tool and run the automatic background remover.
            </li>
            <li>
              <strong>Choose a solid color background:</strong> White, soft gray, or muted blue are perfect for professional portraits.
            </li>
            <li>
              <strong>Refine edges with the brush editor:</strong> Clean up stray hairs, collar areas, and any clothing edges.
            </li>
            <li>
              <strong>Export at high resolution:</strong> Download a crisp PNG or JPG suitable for LinkedIn, company websites, and resume profiles.
            </li>
          </ol>
          ...
          <div className="bg-cyan-50 border border-cyan-100 rounded-3xl p-6 my-6">
            ...
            <p className="text-sm text-neutral-600 leading-relaxed">
              Use a slightly darker background for formal portraits and a soft white or gray background for modern creative industries. Keep your clothing contrast moderate so the final image looks balanced.
            </p>
          </div>

          <h3 className="text-base font-black text-neutral-900 mt-6 tracking-tight">When to Use Which Background</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="rounded-3xl bg-neutral-50 p-5 border border-neutral-200">
              <h4 className="font-semibold text-neutral-900 mb-2">White Background</h4>
              <p className="text-sm text-neutral-600 leading-relaxed">
                Classic, formal, and ideal for conservative business profiles, resumes, and interviews.
              </p>
            </div>
            <div className="rounded-3xl bg-neutral-50 p-5 border border-neutral-200">
              <h4 className="font-semibold text-neutral-900 mb-2">Soft Gray Background</h4>
              <p className="text-sm text-neutral-600 leading-relaxed">
                A modern, polished choice for tech, creative, and startup professionals.
              </p>
            </div>
          </div>

          <h3 className="text-base font-black text-neutral-900 mt-6 tracking-tight">Export Recommendations</h3>
          <ul className="list-disc pl-5 space-y-2">
            <li>Export at least 1200x1500 pixels for LinkedIn.</li>
            <li>Use PNG for transparency and JPG for web profiles when file size matters.</li>
  ...
  // -------------------------------------------------------------
  // VIEW: ARTICLE 5 - Free Background Remover Guide
  // -------------------------------------------------------------
  if (currentView === 'article-free-background-remover') {
    return (
      <div className="mx-auto max-w-3xl px-6 sm:px-10 py-12 animate-fadeIn bg-white text-neutral-900 border border-neutral-150 rounded-3xl mt-8 mb-16 shadow-lg leading-relaxed">
        {renderHeaderTrail('Free Resource Guide', 'Blog Feed', 'blog')}
        
        <header className="mb-8">
          <div className="flex justify-center mb-4">
            <span className="rounded-full bg-amber-50 px-3 py-1 font-mono text-xs font-extrabold text-amber-600 uppercase tracking-widest">Free Resource</span>
          </div>
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight text-neutral-900 text-center leading-tight mb-4">
            Free Background Remover for Small Business & Social Media
          </h1>
          <p className="text-sm font-medium text-neutral-500 text-center max-w-xl mx-auto">
            Learn how to use a free browser background remover to create high-quality marketing, product, and social media images without any subscription fees.
          </p>
        </header>

        <div className="prose prose-neutral max-w-none text-xs sm:text-sm text-neutral-600 space-y-5 leading-relaxed">
          <p>
            Small businesses and creators need polished visuals, but they often lack expensive photo editing tools. Free browser-based background removal makes it possible to produce professional images quickly and affordably.
          </p>
          
          <h3 className="text-base font-black text-neutral-900 mt-6 tracking-tight">Top Use Cases for Free Background Removal</h3>
          <ul className="list-disc pl-5 space-y-2">
          ...
          <h3 className="text-base font-black text-neutral-900 mt-6 tracking-tight">How to Get the Best Results</h3>
          <ol className="list-decimal pl-5 space-y-2">
            <li>Choose a source image with clear subject/background contrast.</li>
            <li>Use the automatic removal tool to instantly isolate the object.</li>
            <li>Refine edges with the brush editor for tight outlines and hair details.</li>
            <li>Add a solid or branded background to keep your visuals consistent.</li>
            <li>Download high-resolution files ready for websites, posts, or print.</li>
          </ol>

          <div className="bg-amber-50 border border-amber-100 rounded-3xl p-6 my-6">
            <h4 className="text-sm font-black text-amber-900 mb-3">Business Benefit</h4>
            <p className="text-sm text-neutral-600 leading-relaxed">
              Free background removal removes design barriers and helps you scale marketing visuals faster. Use the same cleaned images across listings, ads, and social channels without paying for editing tools.
            </p>
          </div>

          <h3 className="text-base font-black text-neutral-900 mt-6 tracking-tight">Smart Free Tool Workflow</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="rounded-3xl bg-neutral-50 p-5 border border-neutral-200">
              <h4 className="font-semibold text-neutral-900 mb-2">Batch Preview</h4>
              <p className="text-sm text-neutral-600 leading-relaxed">
                Upload several images and compare background results in one session to keep your catalog consistent.
              </p>
            </div>
            <div className="rounded-3xl bg-neutral-50 p-5 border border-neutral-200">
              <h4 className="font-semibold text-neutral-900 mb-2">Social Graphics</h4>
              <p className="text-sm text-neutral-600 leading-relaxed">
                Use transparent PNG exports to layer your product or portrait onto social templates and branding assets.
              </p>
            </div>
          </div>

          <h3 className="text-base font-black text-neutral-900 mt-6 tracking-tight">Free vs Paid Tools</h3>
          <p>
            The biggest advantage of free browser tools is cost-savings and quick access. Paid tools may offer more automation or batch export options, but free solutions are often enough for small teams and single creators.
          </p>
    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12 animate-fadeIn">
      ...
      <div className="text-center mb-12">
        <span className="inline-flex items-center space-x-1.5 rounded-full bg-orange-500/10 px-3 py-1 text-xs font-bold text-orange-400 border border-orange-500/20 uppercase tracking-widest mb-3 animate-pulse">
          <BookOpen className="h-3 w-3" />
          <span>BGIRemove User Guides</span>
        </span>
