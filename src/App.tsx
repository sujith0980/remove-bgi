...
export default function App() {
  ...
  useEffect(() => {
    ...
    let description =
      "Remove image backgrounds instantly using BGI Remove. Fully client-side, secure, and free.";
    ...
    switch (activeSection) {
      case "about":
        ...
        description =
          "Discover the mission behind BGI Remove—built entirely for secure, client-side browser backgrounds erasure with zero data storage.";
        ...
        schemaData = {
          ...
          description:
            "Learn about BGI Remove - our local serverless AI processing models and core commitments to complete privacy and premium tools.",
        };
        break;
      case "contact":
        title = "Contact Us & Direct Technical Support | BGI Remove";
        description =
          "Contact our specialist technical team directly or send your feedback and model requests using our integrated form.";
        ...
        schemaData = {
          ...
          description:
            "Send us direct support messages, technical feedback, or customized request notes regarding regional biometric features.",
        };
        break;
      case "upload":
        title = "BGI Remove - Free High Resolution Background Remover";
        description =
          "Remove image backgrounds automatically and for free using BGI Remove. Fully client-side, secure, and offline-capable.";
        schemaData = {
          "@context": "https://schema.org",
          "@type": "WebApplication",
          name: "BGI Remove",
          ...
          description:
            "Premium local serverless background removal tool powered by high precision WASM segmented neural models.",
          offers: {
            "@type": "Offer",
            price: "0.00",
            priceCurrency: "USD",
      ...
      case "backdrop":
        ...
        description =
          "Replace image backgrounds with white, solid studio colors, or custom templates instantly. High quality and 100% private.";
        schemaData = {
          "@context": "https://schema.org",
          "@type": "WebApplication",
          ...
          operatingSystem: "All",
          description:
            "Change backgrounds on cutout images instantly using color pickers, blur sliders, and stock preset backdrops.",
          offers: {
            "@type": "Offer",
            price: "0.00",
            priceCurrency: "USD",
      ...
      case "pricing":
        ...
        description =
          "Explore free beta pricing plans for high-resolution background removal. Zero subscription fees, zero server watermarks.";
        schemaData = {
          "@context": "https://schema.org",
          "@type": "WebApplication",
          ...
          operatingSystem: "All",
          description:
            "Unlock premium float32 4K background eraser layers during our open free beta trial.",
          offers: {
            "@type": "Offer",
            price: "0.00",
            priceCurrency: "USD",
      ...
      case "docs":
        ...
        description =
          "Browse tutorials on biometric passport cropping, background erasing, transparent PNG isolation, and studio settings.";
        schemaType = "Article";
        break;
      case "blog":
        title = "BGI Remove Blog - Photo Editing Skills & Benchmarks";
        description =
          "Discover tips, photography tricks, and comparison benchmark studies written by digital design creators.";
        schemaType = "Article";
        break;
      case "passport-photo":
        title =
          "Passport Photo Background Remover & Biometric Rules | BGI Remove";
        description =
          "Prepare US and EU compliant biometric passport photos by instantly replacing backgrounds with solid flat studio white.";
        schemaType = "Article";
        break;
      case "white-background":
        title = "Remove White Backgrounds Online & Isolate Icons | BGI Remove";
        description =
          "Automatically isolate transparent outlines and vector masks from original white backdrops without quality loss.";
        schemaType = "Article";
        break;
      case "free-remover":
        title = "100% Free Serverless Image Background Removal | BGI Remove";
        description =
          "Learn how BGI Remove utilizes advanced local client web-assembly parameters to remain 100% free of cloud costs.";
        schemaType = "Article";
        break;
      case "hd":
        title = "Studio HD 4K Background Remover Quality Settings | BGI Remove";
        description =
          "Access maximum image clarity up to 2800px on your high-definition graphics using local float32 neural parameters.";
        schemaType = "Article";
        break;
      case "article-remove-bg":
        title = "How to Remove Image Backgrounds Perfectly - Master Tutorial";
        description =
          "A guide to professional photo masking—covering optimal shooting angles, lighting, and pixel level contrast tricks.";
        schemaType = "Article";
        break;
      case "article-best-ai":
        title = "Best Background Removers in 2026: Speed vs Cost";
        description =
          "An in-depth performance study testing local browser WASM runtimes against high-priced cloud servers.";
        schemaType = "Article";
        break;
      case "article-product-photos":
        title = "A Guide to Product Background Removal for Shopify Stores";
        description =
          "Increase storefront sales by automatically isolating product items onto pristine, distraction-free neutral tiles.";
        schemaType = "Article";
        break;
      case "article-professional-headshots":
        title =
          "Professional Headshots: Remove Backgrounds for LinkedIn & Portfolios";
        description =
          "Create clean, professional headshots with background removal and smart portrait styling for resumes, networks, and profiles.";
        schemaType = "Article";
        break;
      case "article-free-background-remover":
        title = "Free Background Remover for Small Business & Social Media";
        description =
          "Use free browser-based background removal to make product photos, social graphics, and marketing visuals look premium.";
        schemaType = "Article";
        break;
    }
  ...
  const handleNavClick = (
    destination: "upload" | "backdrop" | "pricing" | "docs" | "blog" | string,
  ) => {
    ...
    try {
      ...
      if (qualityMode === "isnet_quint8") {
        ...
        setCurrentImage((prev) =>
          prev
            ? { ...prev, progressStep: "Optimizing and resizing image..." }
            : null,
        );
      ...
      try {
        processedSrcToSegment = await resizeImageToMax(
          imageSrc,
          resizeDimension,
        );
      } catch (resizeErr) {
      ...
      console.warn(
        "Real background-removal failed or security blocked. Running local contour fallback.",
        err,
      );
    ...
    <div className="min-h-screen flex flex-col bg-zinc-950 text-zinc-100 selection:bg-orange-500 selection:text-white font-sans">
      ...
      <main className="flex-1 flex flex-col">
        {[
          ...
          "article-professional-headshots",
          "article-free-background-remover",
          "about",
          "contact",
          ...
          <>
            {croppingImage ? (
              ...
              <>
                  ...
                  <section className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-12 md:py-20 flex-1 flex flex-col justify-center">
                    ...
                    <div className="text-center mb-12">
                      ...
                      <p className="mt-4 text-base sm:text-lg text-zinc-400 max-w-2xl mx-auto">
                        100% automatic and free. Processing is done securely in
                        your browser—your files never leave your computer.
                      </p>
                    </div>

                    {/* Core Interactive Sandbox Card layout */}
                    <div
                      className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch w-full mb-12"
                      id="try-it-now"
                    >
                      ...
                      <div className="lg:col-span-7 flex flex-col">
                        ...
                        >
                          ...
                          <div className="absolute bottom-4 text-[10px] text-zinc-500 bg-zinc-950 border border-zinc-850 rounded px-2.0 py-0.5 shadow-sm font-mono flex items-center space-x-1 select-none">
                            <span>Press</span>
                            <span className="bg-zinc-900 px-1 rounded font-semibold text-[9px] text-zinc-400 border border-zinc-800">
                              Ctrl + V
                            </span>
                        ...
                        <div className="p-6 rounded-2xl border border-zinc-800 bg-zinc-900/30 flex-1 flex flex-col justify-center space-y-4">
                          <div className="flex items-start space-x-3 text-xs leading-relaxed">
                            ...
                            <div>
                              ...
                              <p className="text-zinc-400 text-[11px] mt-0.5 font-medium">
                                Your graphics are secure and private—all
                                rendering is done via high-speed WebAssembly
                          ...
                          <div className="flex items-start space-x-3 text-xs leading-relaxed">
                            ...
                            <div>
                              ...
                              <p className="text-zinc-400 text-[11px] mt-0.5 font-medium">
                                Instantly apply studio-style solid colors,
                                subtle gradients, or blurred background
                                templates.
                              </p>
                            </div>
                          </div>
                      ...
                      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2.5">
                          ...
                          <div className="hidden lg:flex items-center space-x-1 bg-zinc-950 p-1.5 rounded-xl border border-zinc-850">
                            <span className="text-[9px] font-bold text-zinc-500 uppercase tracking-widest px-2 font-mono">
                              Engine Profile:
                            </span>
                        ...
                        <div className="max-w-md w-full text-center space-y-6">
                          ...
                          <div className="space-y-2">
                            ...
                            <p className="text-xs text-zinc-400 font-sans font-medium max-w-xs mx-auto animate-pulse">
                              {currentImage.progress < 30
                                ? "Setting up edge vectors..."
                                : currentImage.progress < 90
                                  ? "Isolating pixel boundaries..."
                                  : "Restoring high-res details..."}
                            </p>
                          </div>
                          ...
                          <p className="text-[10px] text-zinc-500 italic">
                            First run might take up to 20 seconds to fetch
                            required local parameters. Consecutive trials occur
                            instantly in offline state.
                          </p>
                        </div>
                      </div>
                    )}
                            ...
                            <div className="flex items-start space-x-3">
                              ...
                              <div className="space-y-1">
                                ...
                                <p className="text-[11px] text-zinc-400 leading-relaxed">
                                  Segmentation algorithms focus mostly on human
                                  silhouettes and ignore inanimate furniture.
                                  Open the editor and use the new{" "}
                                  <strong>Smart Wand</strong> tool: simply click
                                  on the missing laptop or table, and the editor
                                  will auto-detect and restore the entire object
                                  instantly!
                                </p>
                              </div>
                            </div>
                          ...
                          <div className="bg-zinc-900 rounded-xl border border-zinc-800 p-4 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm">
                            <div className="text-center sm:text-left">
                              ...
                              <p className="text-xs text-zinc-400 mt-0.5">
                                High-quality PNG processed entirely inside your
                                browser sandbox.
                              </p>
                            </div>
                        ...
                        <div className="lg:col-span-5 flex flex-col space-y-6">
                          ...
                          <div className="bg-zinc-900 rounded-2xl border border-zinc-800 p-5 shadow-sm space-y-3">
                            ...
                            <p className="text-[11px] text-zinc-400 leading-relaxed font-mono">
                              Did the automatic cutting miss any hair details or
                              strap lines? Click above to rub out or bring back
                              parts of the image with a customized cursor brush!
                            </p>
                          </div>
                          ...
                          <div
                            ...
                            className="bg-zinc-900 rounded-2xl border border-zinc-800 p-5 shadow-sm space-y-5"
                          >
                            <div>
                              ...
                              <p className="text-[10px] text-zinc-500 leading-tight">
                                Replace the transparent layout with vibrant
                                artistic themes
                              </p>
                            </div>
                              ...
                              {editorSettings.backgroundType ===
                                ...
                                <div className="h-28 rounded-xl border border-dashed border-zinc-800 flex items-center justify-center bg-zinc-950 hover:bg-zinc-900 transition cursor-pointer select-none">
                                  <div className="text-center space-y-1 p-4">
                                    ...
                                    <p className="text-[10px] text-zinc-500">
                                      Suitable for graphic designs, logos, and
                                      catalogs.
                                    </p>
                                  </div>
                                </div>
                                  ...
                                  <div className="grid grid-cols-5 gap-2.5">
                                    {COLOR_PRESETS.map((preset) => (
                                      ...
                                      >
                                        {selectedPresetId === preset.id && (
                                          <Check
                                            className={`h-4.5 w-4.5 ${preset.value === "#FFFFFF" || preset.value === "#F3F4F6" ? "text-zinc-950 font-bold" : "text-white"}`}
                                          />
                                        )}
                                      </button>
                                    ))}
                                ...
                                <div className="space-y-4">
                                  ...
                                  <div className="grid grid-cols-4 gap-2">
                                    ...
                                    >
                                      ...
                                      <span className="text-[8px] mt-1 font-sans text-zinc-500">
                                        Custom
                                      </span>
                                    </button>
                                    <input
                ...
                <section
                  id="pricing-section"
                  className="bg-neutral-50 border-t border-neutral-150 py-16 md:py-20 text-neutral-800"
                >
                  <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                    {/* Main heading */}
                    <div className="text-center max-w-3xl mx-auto mb-14">
                      <h2 className="text-3xl sm:text-4xl font-extrabold text-neutral-900 tracking-tight leading-tight">
                        Flexible Processing Profiles.{" "}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-red-600">
                          Zero Cost.
                        </span>
                      </h2>
                      <p className="mt-4 text-sm text-neutral-500 font-medium leading-relaxed max-w-xl mx-auto">
                        Our editor performs all neural network segmentation
                        locally in your browser sandbox. Enjoy high-performance
                        background removal with no subscription fees or server
                        wait queues.
                      </p>
                    </div>
                      ...
                      <div className="rounded-2xl border border-neutral-200 bg-white p-6 flex flex-col justify-between shadow-xs hover:border-neutral-300 transition duration-150">
                        <div>
                          <div className="flex items-center justify-between pb-3 border-b border-neutral-100">
                            ...
                            <span className="text-[9px] font-mono font-bold text-neutral-400 bg-neutral-100 px-1.5 py-0.5 rounded font-extrabold uppercase">
                              Basic
                            </span>
                          </div>
                          <p className="text-[11px] text-neutral-400 mt-2 font-medium">
                            Highly optimized for instant web drafts and quick
                          ...
                          <div className="mt-5">
                            <div className="flex items-baseline">
                              ...
                              <span className="text-[10px] text-neutral-450 font-semibold ml-1">
                                / forever
                              </span>
                            </div>
                          </div>
                      ...
                      <div className="rounded-2xl border-2 border-orange-500 bg-white p-6 flex flex-col justify-between shadow-xs relative font-sans">
                        ...
                        <div>
                          <div className="flex items-center justify-between pb-3 border-b border-neutral-100">
                            ...
                            <span className="text-[9px] font-mono font-bold text-orange-400 bg-orange-50 px-1.5 py-0.5 rounded border border-orange-100 uppercase font-extrabold">
                              Optimal
                            </span>
                          </div>
                          <p className="text-[11px] text-neutral-400 mt-2 font-medium">
                            The optimal balance of speed and perimeter accuracy
                            for portrait cutouts.
                          </p>
                          ...
                          <button
                            ...
                            onClick={() =>
                              setBetaModal({
                                ...
                                description:
                                  "The Balanced Pro engine processes up to 1600px sizes using high precision float16 parameters for optimal portrait outline accuracy and speeds.",
                              })
                            }
                      ...
                      <div className="rounded-2xl border border-neutral-200 bg-white p-6 flex flex-col justify-between shadow-xs hover:border-neutral-300 transition duration-150">
                        <div>
                          <div className="flex items-center justify-between pb-3 border-b border-neutral-100">
                            ...
                            <span className="text-[9px] font-mono font-bold text-neutral-400 bg-neutral-100 px-1.5 py-0.5 rounded font-extrabold uppercase font-semibold">
                              Premium
                            </span>
                          </div>
                          <p className="text-[11px] text-neutral-400 mt-2 font-medium">
                            Full accuracy float32 neural maps for print-ready
                          ...
                          <div className="mt-5">
                            <div className="flex items-baseline">
                              ...
                              <span className="text-[10px] text-purple-600 font-bold ml-1.5">
                                (Free Beta)
                              </span>
                            </div>
                          </div>
                          ...
                          <button
                            ...
                            onClick={() =>
                              setBetaModal({
                                ...
                                targetMode: "isnet",
                                description:
                                  "The Studio HD engine runs a complete float32 neural accuracy matrix to capture maximum boundary edges and fine details up to 2800px high-resolution width.",
                              })
                            }
          ...
          <div className="relative w-full max-w-md overflow-hidden rounded-2xl border border-neutral-100 bg-white shadow-xl animate-scaleIn">
            ...
            <div className="bg-gradient-to-r from-orange-500 to-red-600 p-6 text-white text-center relative overflow-hidden">
              ...
              <h3 className="text-lg font-extrabold tracking-tight">
                Free Beta Premium Access
              </h3>
              <p className="text-[10px] text-orange-100 mt-1 uppercase tracking-widest font-bold">
                Active Promo Period
              </p>
            </div>
            ...
            <div className="p-6">
              <div className="text-center mb-5">
                <div className="text-neutral-400 text-[10px] font-mono font-bold uppercase tracking-wider mb-1">
                  UNLOCKED ENGINE
                </div>
                <h4 className="text-xl font-extrabold text-neutral-900 tracking-tight">
                  {betaModal.profileName}
                </h4>

                <div className="mt-4.5 inline-flex items-center space-x-2 bg-neutral-50 px-3.5 py-2 rounded-xl border border-neutral-100">
                  <span className="text-neutral-400 line-through text-xs font-bold font-mono">
                    {betaModal.originalPrice}
                  </span>
                  <span className="text-neutral-300 font-mono text-[11px] font-semibold">
                    →
                  </span>
                  <span className="text-orange-650 font-black text-sm font-mono">
                    $0.00
                  </span>
                  <span className="text-orange-600 font-extrabold text-[9px] bg-orange-50 border border-orange-100 rounded-lg px-2 py-0.5 tracking-wider uppercase font-sans">
                    100% Free Beta
                  </span>
                </div>
              </div>
              ...
              <p className="text-xs text-neutral-500 font-medium leading-relaxed text-center mb-6">
                {betaModal.description} All computations perform directly inside
                your secure local browser sandbox. Enjoy unlimited edits with
                zero fees.
              </p>
              ...
              <div className="space-y-2">
                <button
                  ...
                  onClick={() => {
                    ...
                    if (currentImage) {
                      const source =
                        currentImage.originalFile || currentImage.originalUrl;
                      if (source) {
                        setTimeout(() => {
